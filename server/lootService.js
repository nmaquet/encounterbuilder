...
function createLootService(diceService, knapsackService, clone, idify) {
    ...
    service.generateMagicArmorOrShieldByBonus = function (armorBonus, abilityLevel1, abilityLevel2) {
...
module.exports = function (diceService, knapsackService, clone, idify) {
    return createLootService(diceService, knapsackService, clone, idify);
};