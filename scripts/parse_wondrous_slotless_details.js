...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_slotless_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/slotless.json", JSON.stringify(items, null, 4));
