...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_neck_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/necks.json", JSON.stringify(items, null, 4));
