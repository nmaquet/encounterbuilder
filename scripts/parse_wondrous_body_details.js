...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_body_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/body.json", JSON.stringify(bodys, null, 4));
