...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_head_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/head.json", JSON.stringify(items, null, 4));
