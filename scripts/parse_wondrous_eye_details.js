...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_eyes_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/eyes.json", JSON.stringify(items, null, 4));
