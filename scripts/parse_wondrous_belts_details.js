...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_belt_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/belts.json", JSON.stringify(belts, null, 4));
