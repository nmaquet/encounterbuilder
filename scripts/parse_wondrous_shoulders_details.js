...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_shoulder_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/shoulders.json", JSON.stringify(items, null, 4));
