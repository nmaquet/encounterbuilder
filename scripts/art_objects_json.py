...
if __name__ == "__main__":
    ...
    for magnitude in items:
        artObjects += parseTable(items[magnitude], magnitude)
        string = json.dumps(artObjects, indent=4, sort_keys=True)
        with open("../data/items/art-objects.json", "w") as f:
            f.write(string)