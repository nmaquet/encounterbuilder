...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_chest_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/chests.json", JSON.stringify(items, null, 4));
