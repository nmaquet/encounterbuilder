...
var html = fs.readFileSync(__dirname + '/../data/prd_fixed_html/wondrous_feet_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/feet.json", JSON.stringify(items, null, 4));
