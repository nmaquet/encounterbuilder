...
var html = fs.readFileSync(__dirname + '/../data/contrib/wondrous_wrists_descriptions_prd.html');
...
fs.writeFileSync(__dirname + "/../data/items/wrists.json", JSON.stringify(items, null, 4));
