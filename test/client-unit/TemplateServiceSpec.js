...
describe("templateService", function () {
    ...
    it("shouldn't do anything if no templates are selected", function () {
        ...
        delete baseMonster.templates; // templates aren't copied to the templatedMonster

        expect(JSON.stringify(templatedMonster)).to.equal(JSON.stringify(baseMonster));
    });
    ...
    it("should  add '(Advanced)' to the Name for advanced template", function () {
        ...
        expect(service.handleTemplates(baseMonster).Name).to.equal("Solar (Advanced)");
    });
    ...
    it("should  add 1 to the CR for advanced template", function () {
        ...
        expect(service.handleTemplates(baseMonster).CR).to.equal(24);
    });
    ...
    it("should  adjust the xp according to the new  CR", function () {
        ...
        expect(service.handleTemplates(baseMonster).XP).to.equal(1228800);
    });
